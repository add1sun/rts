...
class Sparkline extends Object {
  ...
  function Output($file = '') {
    ...
    // transparency please :)
    $colorRGB = $this->GetColor($this->colorBackground);
    $bg = imagecolorallocate($this->imageHandle, $colorRGB[0], $colorRGB[1], $colorRGB[2]);
    imagecolortransparent($this->imageHandle, $bg);
