      ...
      <div id="header">
        <div id="headerTitle" class="grid_12">
          ...
          <div id="title-wrapper" style="float: left;">
            <h1><a href="<?php print check_url($front_page); ?>" title="<?php print check_plain($site_name); ?>"><?php print twofivemile_alt_word_text(check_plain($site_name)); ?></a></h1>
      ...
      <div id="center">
        ...
        <?php if (!empty($title)): ?>
          <div class="headline grid_12 alpha">
            ...
            <?php if (!empty($node) && twofivemile_show_datestamp($node->type)): ?>
