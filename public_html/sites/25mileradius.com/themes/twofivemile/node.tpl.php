...
<?php if ($page == 0): ?>
  <div class="headline grid_12 alpha">
    ...
    <?php if (twofivemile_show_datestamp($node->type)): ?>
...
<?php endif; ?>
  <div class="content">
    ...
    <?php if ($teaser && $readmore): ?>
        <div class="clear"></div>
        <span class="readmore"><?php print twofivemile_read_more_link($node); ?></span>
    <?php endif; ?>
  </div>
  ...
  <div class="clear"></div>
    <div class="meta">
      <?php if ($taxonomy): ?>
        <?php print twofivemile_render_terms($node); ?>
        <?php if ($page == 0): ?> | <?php endif; ?> 
      <?php endif;?>
      <?php if ($comment > 0 && $page == 0): ?>
          <?php //if ($teaser): ?>
            <?php print twofivemile_teaser_comment_link($node); ?>
          <?php //endif; ?>
      <?php else: ?>
          &nbsp;
      <?php endif; ?>
